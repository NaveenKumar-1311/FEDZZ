...
def execution(mutation, Zalloc,global_acc1, global_model, global_model1, global_model2):
    ...
    for g_epoch in range(global_epochs):
            ...
            if int(client[8:]) in z1:
                ...
                for epoch in range(local_epochs):
                    ...
                    for batch_idx, (data, target) in enumerate(clients_batched[client]):
                        ...
                        if client == "clients_1" or client == "clients_3" or client == "clients_5" or client == "clients_7" or client == "clients_9" or client == "clients_11" or client == "clients_13" or client == "clients_15" or client == "clients_17" or client == "clients_19" or client == "clients_21" or client == "clients_23" or client == "clients_25" or client == "clients_27" or client == "clients_29" or client == "clients_31" or client == "clients_33" or client == "clients_35" or client == "clients_37" or client == "clients_39":
        ...
        np.save('GTAA_40client_het_noattack_2z20A10pz_16102022.npy', GTAA)
        np.save('./40c2z20A/selclientids_noattack_2z20A10pz_16102022_'+str(cntr)+'.npy', selclientids)
        cntr += 1
