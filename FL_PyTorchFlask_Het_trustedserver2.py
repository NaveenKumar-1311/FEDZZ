...
def execution(mutation, Zalloc,global_acc1, global_model, global_model1, global_model2):
    ...
    for g_epoch in range(global_epochs):
        ...
        np.save('GTAA_40client_het_noattack_2z10pz_18Jul2022.npy', GTAA)
        #np.save('./40c10z1A/predictions_randomsel201A_C5allrounds_772022_heter_'+str(cntr)+'.npy', selclientids)
        #cntr += 1
